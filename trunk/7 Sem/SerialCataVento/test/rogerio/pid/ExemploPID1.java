 ...
 * @author rogerio
 */
public class ExemploPID1 implements iPID {

	public ExemploPID1(double p_factor, double i_factor, double d_factor) {
		p = p_factor;
		i = i_factor;
		d = d_factor;
		sumErrors = 0;
	...
	public double controller(double setPoint, double processValue) {
		...
		double ret = p * (error) + i * sumErrors + d * (processValue - previousValue);
