 ...
 */
public class Testar extends FitnessFunction {

    private static void print(IChromosome bestSolutionSoFar) {
        System.out.println(
                Testar.getNumberOfCoinsAtGene(
        ...
        System.out.println("For a total of "
                + Testar.amountOfChange(
                bestSolutionSoFar) + " cents in "
                + Testar.getTotalNumberOfCoins(
    ...
    /**
     * Constructs this Testar with the desired amount of change to make.
     *
     * @param a_targetAmount The desired amount of change, in cents. This value
     * must be between 1 and 99 cents.
     */
    public Testar(int a_targetAmount) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Testar that we created earlier.
